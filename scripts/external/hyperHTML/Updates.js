...
//import CustomEvent from '../custom-event/index.js';
...
Tagger.prototype = {
  ...
  attribute(node, name, original) {
    ...
    let oldValue;
    // SLEEKNOTE, we pass tagger as third argument to Intent callback
    var me = this;
    ...
    // in this case assign the value directly
      ...
      return newValue => {
		  ...
		  // SLEEKNOTE
		  if (oldValue !== newValue || name == 'checked' || name == 'selected') {
		  //
        /*if (oldValue !== newValue) {*/
          oldValue = newValue;
      ...
      oldValue;
      return any => {
        const newValue = Intent.attributes[name](node, any, me); //SLEEKNOTE
        if (oldValue !== newValue) {
          oldValue = newValue;
          if (newValue == null)
            node.removeAttribute(name);
